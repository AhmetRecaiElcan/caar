...
class BydSealUdmiDetails extends StatefulWidget {
  final Car car;
  const BydSealUdmiDetails({required this.car});

  @override
  _BydSealUdmiDetailsState createState() => _BydSealUdmiDetailsState();
}

class _BydSealUdmiDetailsState extends State<BydSealUdmiDetails> {
  int _currentImage = 0;
