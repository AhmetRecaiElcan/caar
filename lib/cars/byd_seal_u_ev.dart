...
class BydSealUEvDetails extends StatefulWidget {
  final Car car;
  const BydSealUEvDetails({required this.car});

  @override
  _BydSealUEvDetailsState createState() => _BydSealUEvDetailsState();
}

class _BydSealUEvDetailsState extends State<BydSealUEvDetails> {
  int _currentImage = 0;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: [
                          buildSpecificationCar("Menzil", "500 km"),
                          buildSpecificationCar("Şanzıman", "Otomatik"),
                          buildSpecificationCar("Koltuk", "5"),
                          buildSpecificationCar("Yakıt", "Elektrik"),
                          buildSpecificationCar("Hız (0-100)", "9.6 sn."),
                          buildSpecificationCar("Maks. Hız", "175 mph"),
                        ],
                      ),
                    ),
                  ],
