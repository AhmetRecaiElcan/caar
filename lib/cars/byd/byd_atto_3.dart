...
class BydAtto3Details extends StatefulWidget {
  final Car car;
  const BydAtto3Details({required this.car});

  @override
  _BydAtto3DetailsState createState() => _BydAtto3DetailsState();
}

class _BydAtto3DetailsState extends State<BydAtto3Details> {
  int _currentImage = 0;
