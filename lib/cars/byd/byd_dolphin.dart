...
class BydDolphinDetails extends StatefulWidget {
  final Car car;
  const BydDolphinDetails({required this.car});

  @override
  _BydDolphinDetailsState createState() => _BydDolphinDetailsState();
}

class _BydDolphinDetailsState extends State<BydDolphinDetails> {
  int _currentImage = 0;
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => WebViewScreen(url: 'https://bydauto.mncdn.com/storage/pdf/teknik/byd-dolphin-teknik-brosur.pdf'),
            ),
          );
        },
        child: Text(
