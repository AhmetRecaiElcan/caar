...
class TeslaDetails extends StatefulWidget {
  final Car car;
  const TeslaDetails({required this.car});

  @override
  _TeslaDetailsState createState() => _TeslaDetailsState();
}

class _TeslaDetailsState extends State<TeslaDetails> {
  int _currentImage = 0;
