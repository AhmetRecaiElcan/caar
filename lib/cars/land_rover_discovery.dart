...
class LandRoverDiscoveryDetails extends StatefulWidget {
  final Car car;
  const LandRoverDiscoveryDetails({required this.car});

  @override
  _LandRoverDiscoveryDetailsState createState() => _LandRoverDiscoveryDetailsState();
}

class _LandRoverDiscoveryDetailsState extends State<LandRoverDiscoveryDetails> {
  int _currentImage = 0;
