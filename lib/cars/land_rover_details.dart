...
class LandRoverDetails extends StatefulWidget {
  final Car car;
  const LandRoverDetails({required this.car});

  @override
  _LandRoverDetailsState createState() => _LandRoverDetailsState();
}

class _LandRoverDetailsState extends State<LandRoverDetails> {
  int _currentImage = 0;
