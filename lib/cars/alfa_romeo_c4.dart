...
class AlfaRomeoC4Details extends StatefulWidget {
  final Car car;
  const AlfaRomeoC4Details({required this.car});

  @override
  _AlfaRomeoC4DetailsState createState() => _AlfaRomeoC4DetailsState();
}

class _AlfaRomeoC4DetailsState extends State<AlfaRomeoC4Details> {
  int _currentImage = 0;
